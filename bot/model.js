...
module.exports = {
  getStateSize, getActionFeatureSize,
  encodeGameState, encodeGameStateForPlayer, encodeActions, encodeCardList, hashCardId,
  NeuralNet, Layer, selectBestAction, selectTopActions,
  findActivePlayerId, STATE_SIZE, ACTION_FEATURE_SIZE
};
